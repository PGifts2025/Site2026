...
`{ "path": "/api/cron/sync-laltex-stock", "schedule": "0 6,9,12,15,18,21 * * *" }`
— every 3 hours, 6 runs/day. Vercel Cron is UTC and cannot track DST. Change
cadence by editing ONLY that string.
